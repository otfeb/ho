						...
						<li class="parent"><a href="#">about 회원</a>
							<ul class="sub-menu">
								...
								<li><a href="<%=root%>/index.jsp?main=login/loginmain.jsp"><i
										class="bi bi-box-arrow-in-right"></i> 로그인</a></li>
								<%
								} else {
								%>
								<li><a href="<%=root%>/index.jsp?main=login/logoutform.jsp"><i
										class="bi bi-box-arrow-in-right"></i> 로그아웃</a></li>
								<%
								}
								%>
								<li><a
									href="<%=root%>/index.jsp?main=member/memberform.jsp"><i
										class="bi bi-file-earmark-person"></i> 회원가입</a></li>
								<%
								if (loginok == "yes" && myid.equals("admin")) {
								%>
								<li><a
									href="<%=root%>/index.jsp?main=member/memberlist.jsp"><i
										class="bi bi-person-lines-fill"></i> 회원목록</a></li>
								<li><a href="<%=root%>/index.jsp?main=member/myinfo.jsp"><i
										class="bi bi-person-lines-fill"></i> 나의정보</a></li>
								<%
								} else if (loginok == "yes") {
								%>
								<li><a href="<%=root%>/index.jsp?main=member/myinfo.jsp"><i
